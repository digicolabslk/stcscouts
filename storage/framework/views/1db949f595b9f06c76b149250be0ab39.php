                ...
                <div class="blog-posts single-post">
                    ...
                    <article class="post post-large blog-single-post border-0 m-0 p-0">
                        ...
                        <p class="text-dark text-center text-4">Chief Commissioner’s Award –<a
                                href="<?php echo e(asset('scout_docs/Chief-Commissioners-Award.pdf')); ?>" target="_blank">Download</a>
                        ...
                        <p class="text-dark text-center text-4">President’s Award  –<a
                                href="<?php echo e(asset('scout_docs/PRESIDENTS-AWARD.pdf')); ?>" target="_blank">Download</a>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\stcscouts\resources\views/badgework-new-syllabus.blade.php ENDPATH**/ ?>