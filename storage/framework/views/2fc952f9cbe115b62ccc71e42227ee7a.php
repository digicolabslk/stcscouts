...
<head>
    ...
    <?php
        ...
        $siteLogoURL = "/images/stcscouts_logo.jpg";
    ...
    <meta name="keywords" content="Scout Movement, youth development, outdoor activities, leadership training,
    ...
    <meta property="og:image" content="<?php echo e($siteLogoURL); ?>">
    ...
    <meta name="twitter:image" content="<?php echo e($siteLogoURL); ?>">

    <script type="application/ld+json">
        {
          "@context": "https://schema.org",
          "@type": "WebPage",
          "name": "<?php echo e($siteTitle); ?>",
              "description": "<?php echo e($siteDescription); ?>",
                        ...
                        <div class="header-row">
                            <div class="header-nav header-nav-line header-nav-bottom-line">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li class="dropdown-submenu">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            <li><a class="dropdown-item" href="feature-layout-rtl.html">RTL</a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                    <li class="dropdown-submenu">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="feature-style-switcher.html">Style
                                ...
                                <ul class="header-social-icons social-icons d-none d-sm-block">
                                    <li class="social-icons-facebook"><a href="http://www.facebook
											.com/stcscouts" target="_blank" title="Facebook"><i class="fab
                                    ...
                                    <li class="social-icons-youtube"><a href="https://www.youtube.com/@stcscouts"
                                                                        target="_blank" title="YouTube"><i class="fab
																		  fa-youtube"></i></a></li>
                                </ul>
            ...
            <div class="row py-5 my-4">
                <div class="col-md-6 mb-4 mb-lg-0">
                    ...
                    <p class="mt-2 mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec eu pulvinar
                        magna. Phasellus semper scelerisque purus, et semper nisl lacinia sit amet. Praesent venenatis
                        turpis vitae purus semper...</p>
                        ...
                        <div class="col-md-6">
                            <ul class="list list-icons list-icons-sm">
                                ...
                                <li><i class="fas fa-angle-right"></i><a href="sitemap.html"
                                                                         class="link-hover-style-1 ms-1"> Sitemap</a>
                                </li>
                                <li><i class="fas fa-angle-right"></i><a href="contact-us.html"
                                                                         class="link-hover-style-1 ms-1"> Contact Us</a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container py-2">
                <div class="row">
                    <div class="col d-flex align-items-center justify-content-center">
                        <i><p style="color:#cccccc!important;">© 2003 - 2024 - 16<sup>th</sup>
                                Colombo Scout
                                Group
                                of S.
                                Thomas'
                                College, Mount Lavinia. All rights
                                reserved. </p></i>
                ...
                <div class="row">
                    <div class="col d-flex align-items-center justify-content-center">
                        <i><p style="color:#cccccc!important;" class="font-italic"> Made with &hearts; by: Sidath
                                Gajanayaka in
                                collaboration with <a target="_blank" href="https://www.digicolabs.com/">Digico Labs
                                    (Private) Limited</a>.</p></i>
                    </div>
                </div>
...
<?php /**PATH D:\Projects\stcscouts\resources\views/layouts/main_template.blade.php ENDPATH**/ ?>